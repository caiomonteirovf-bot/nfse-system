...
from backend.routers import tomadores, nfses, emissao, prestador, empresas, xml_logs, captura, clientes, cnpj, fator_r
...
app.include_router(fator_r.router, prefix="/api")
